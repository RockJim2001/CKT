...
@pytest.mark.parametrize(
    'cfg_file',
    [
        'detection/attention_rpn/voc/split1-10shot-10shot/attention-rpn_r50_c4_voc-split1_base-training.py',  # noqa
        'detection/attention_rpn/voc/split1-10shot-10shot/attention-rpn_r50_c4_voc-split1_1shot-fine-tuning.py'  # noqa
    ])
