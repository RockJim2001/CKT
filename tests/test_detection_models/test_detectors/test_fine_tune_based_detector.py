...
@pytest.mark.parametrize(
    'cfg_file',
    [
        'detection/tfa/voc/split1-10shot-10shot/tfa_r101_fpn_voc-split1_base-training.py',  # noqa
        'detection/tfa/voc/split1-10shot-10shot/tfa_r101_fpn_voc-split1_1shot-fine-tuning.py',  # noqa
        'detection/fsce/voc/split1-10shot-10shot/fsce_r101_fpn_voc-split1_base-training.py',  # noqa
        'detection/fsce/voc/split1-10shot-10shot/fsce_r101_fpn_contrastive-loss_voc-split1_3shot-fine-tuning.py'  # noqa
    ])
