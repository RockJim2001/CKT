...
bash ./tools/detection/dist_train.sh \
    configs/detection/fsdetview/voc/split1-10shot-10shot/fsdetview_r101_c4_8xb4_voc-split1_base-training.py 8

# step2: few shot fine-tuning
bash ./tools/detection/dist_train.sh \
    configs/detection/fsdetview/voc/split1-10shot-10shot/fsdetview_r101_c4_8xb4_voc-split1_1shot-fine-tuning.py 8
```
