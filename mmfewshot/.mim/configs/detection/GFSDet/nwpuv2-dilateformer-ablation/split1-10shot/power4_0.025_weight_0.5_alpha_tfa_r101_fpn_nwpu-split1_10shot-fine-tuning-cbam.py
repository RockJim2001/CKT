    ...
    roi_head=dict(
        bbox_head=dict(
            ...
            dis_loss=dict(
                ...
                power_weight=4.0),
            base_cpt='work_dirs/nwpuv2-ablation_study/10-shot/dilateform/tfa_r101_fpn_nwpuv2_split1_base-training/cbam/base_model_random_init_bbox_head_original.pth',
            init_cfg=[
                dict(
                    type='Caffe2Xavier',
...
load_from = ('work_dirs/nwpuv2-ablation_study/10-shot/dilateform/tfa_r101_fpn_nwpuv2_split1_base-training/cbam/base_model_random_init_bbox_head_original.pth')
work_dir = './work_dirs/nwpuv2-ablation_study/10-shot/dilateform/tfa_r101_fpn_nwpuv2_split1_base-training/cbam/power4_0.025_weight_0.5_alpha_tfa_r101_fpn_nwpu-split1_10shot-fine-tuning-30000'
