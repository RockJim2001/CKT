    ...
    roi_head=dict(
        bbox_head=dict(
            ...
            dis_loss=dict(
                ...
                power_weight=4.0),
            base_cpt='work_dirs/rep/tfa_r101_fpn_dior_split1_base-training/base_model_random_init_bbox_head_dilateform.pth',
            init_cfg=[
                dict(
                    type='Caffe2Xavier',
...
load_from = ('work_dirs/rep/tfa_r101_fpn_dior_split1_base-training/base_model_random_init_bbox_head_dilateform.pth')
