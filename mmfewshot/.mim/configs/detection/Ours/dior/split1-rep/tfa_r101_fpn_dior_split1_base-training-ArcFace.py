...
data = dict(
    ...
    val=dict(classes='BASE_CLASSES_SPLIT1',
             ...
             #     dict(
             #         type='ann_file',
             #         ann_file='data/DIOR/DIOR2017/ImageSets/Main/trainval.txt')
             # ],
             ),
...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            loss_cls=dict(
                type='ClasswiseMarginArcFaceLoss',
                num_classes=15,
                s=64.0,
                init_margin=0.5,
...
work_dir = './work_dirs/dior-rep/split1/AdaptiveResidual_ArcFace/tfa_r101_fpn_dior_split1_base-training'
