...
data = dict(
    train=dict(
        ...
        ann_cfg=[dict(method='TFA', setting='SPLIT5_5SHOT')],
        num_novel_shots=5,
        num_base_shots=5,
...
work_dir = './work_dirs/dior/split2/power4_0.025_weight_0.5_alpha_tfa_r101_fpn_dior-split4_5shot-fine-tuning.py'