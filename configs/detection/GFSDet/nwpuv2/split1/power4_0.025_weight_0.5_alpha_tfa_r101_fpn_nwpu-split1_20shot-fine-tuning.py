...
model = dict(
    ...
    backbone=dict(depth=101, frozen_stages=0),
    frozen_parameters=[
    ...
    roi_head=dict(
        bbox_head=dict(
            ...
            fusion_type='NovelSharedKnowledgeTransferFusion',
            # fusion_type=None,
            dis_loss=dict(
                type='DisLoss', num_classes=10, shot=20,
                loss_base_margin_weight=1.0,
                loss_novel_margin_weight=1.0,
                loss_neg_margin_weight=1.0,
                power_weight=4.0),
            base_cpt='work_dirs/nwpuv2_rep/split1/AdaptiveResidual/tfa_r101_fpn_nwpuv2_split1_base-training/base_model_random_init_bbox_head.pth',
            # base_cpt='work_dirs/nwpuv2_rep/split1-ori/AdaptiveResidual/tfa_r101_fpn_nwpuv2_split1_base-training/base_model_random_init_bbox_head.pth',
            init_cfg=[
                dict(
                    type='Caffe2Xavier',
...
load_from = ('work_dirs/nwpuv2_rep/split1/AdaptiveResidual/tfa_r101_fpn_nwpuv2_split1_base-training/base_model_random_init_bbox_head.pth')
# load_from = ('work_dirs/nwpuv2_rep/split1-ori/AdaptiveResidual/tfa_r101_fpn_nwpuv2_split1_base-training/base_model_random_init_bbox_head.pth')
work_dir = './work_dirs/nwpuv2_rep/split1/AdaptiveResidual/tfa_r101_fpn_nwpuv2_split1_base-training/power4_0.025_weight_0.5_alpha_tfa_r101_fpn_nwpu-split1_20shot-fine-tuning/NovelSharedKnowledgeTransferFusion'
