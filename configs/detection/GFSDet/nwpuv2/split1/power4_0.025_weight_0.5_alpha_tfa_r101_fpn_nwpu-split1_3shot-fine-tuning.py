...
model = dict(
    ...
    roi_head=dict(
        bbox_head=dict(
            ...
            # fusion_type=None,
            dis_loss=dict(
                type='DisLoss', num_classes=10, shot=3,
...
work_dir = './work_dirs/nwpuv2_rep/split1/AdaptiveResidual/tfa_r101_fpn_nwpuv2_split1_base-training/power4_0.025_weight_0.5_alpha_tfa_r101_fpn_nwpu-split1_3shot-fine-tuning/NovelSharedKnowledgeTransferFusion'
