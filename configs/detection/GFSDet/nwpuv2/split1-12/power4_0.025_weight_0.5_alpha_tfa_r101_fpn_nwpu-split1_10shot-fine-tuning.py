    ...
    roi_head=dict(
        bbox_head=dict(
            ...
            dis_loss=dict(
                ...
                power_weight=4.0),
            base_cpt='work_dirs/nwpuv2_rep/split1-12/AdaptiveResidual/tfa_r101_fpn_nwpuv2_split1_base-training/base_model_random_init_bbox_head.pth',
            init_cfg=[
                dict(
                    type='Caffe2Xavier',
...
load_from = ('work_dirs/nwpuv2_rep/split1-12/AdaptiveResidual/tfa_r101_fpn_nwpuv2_split1_base-training/base_model_random_init_bbox_head.pth')
work_dir = './work_dirs/nwpuv2_rep/split1-12/AdaptiveResidual/tfa_r101_fpn_nwpuv2_split1_base-training/power4_0.025_weight_0.5_alpha_tfa_r101_fpn_nwpu-split1_10shot-fine-tuning/ContrastiveAttentionFusion'
