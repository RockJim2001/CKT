...
data = dict(
    train=dict(
        ...
        ann_cfg=[dict(method='TFA', setting='SPLIT4_10SHOT')],
        num_novel_shots=10,
        num_base_shots=10,
...
work_dir = './work_dirs/dior-rep/split4/AdaptiveResidual/tfa_r101_fpn_dior_split4_base-training/power4_0.025_weight_0.5_alpha_tfa_r101_fpn_dior-split4_10shot-fine-tuning/ContrastiveAttentionFusion'
