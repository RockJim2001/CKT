...
data = dict(
    train=dict(
        ...
        ann_cfg=[dict(method='TFA', setting='SPLIT4_20SHOT')],
        num_novel_shots=20,
        num_base_shots=20,
    ...
    roi_head=dict(
        bbox_head=dict(
            ...
            dis_loss=dict(
                ...
                power_weight=4.0),
            base_cpt='work_dirs/dior-rep/split4/AdaptiveResidual/tfa_r101_fpn_dior_split4_base-training/base_model_random_init_bbox_head.pth',
            init_cfg=[
                dict(
                    type='Caffe2Xavier',
...
load_from = (
    'work_dirs/dior-rep/split4/AdaptiveResidual/tfa_r101_fpn_dior_split4_base-training/base_model_random_init_bbox_head.pth')
work_dir = './work_dirs/dior-rep/split4/AdaptiveResidual/tfa_r101_fpn_dior_split4_base-training/power4_0.025_weight_0.5_alpha_tfa_r101_fpn_dior-split4_20shot-fine-tuning/ContrastiveAttentionFusion'
