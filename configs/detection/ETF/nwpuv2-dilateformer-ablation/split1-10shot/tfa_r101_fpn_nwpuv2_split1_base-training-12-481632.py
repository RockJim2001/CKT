...
work_dir = './work_dirs/nwpuv2-ablation_study/10-shot/dilateform/tfa_r101_fpn_nwpuv2_split1_base-training/dilate_481632'

# 表12中，num_heads = [4,8,16,32], dilation = [1, 2]
