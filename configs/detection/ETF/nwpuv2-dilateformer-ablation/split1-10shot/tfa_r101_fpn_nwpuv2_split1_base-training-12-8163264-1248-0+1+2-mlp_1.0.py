...
work_dir = './work_dirs/nwpuv2-ablation_study/10-shot/dilateform/tfa_r101_fpn_nwpuv2_split1_base-training/dilate_8163264-1248-0+1+2-mlp_1.0'

# 表14中，num_heads = [8,16,32，64], dilation = [1, 2，4，8]，仅仅在stage_0、stage_1、stage_2中使用, mlp=1.
