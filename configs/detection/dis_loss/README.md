...
bash ./tools/detection/dist_train.sh \
    configs/detection/tfa/voc/split1-10shot-10shot/tfa_r101_fpn_voc-split1_base-training.py 8

# step2: reshape the bbox head of base model for few shot fine-tuning
python -m tools.detection.misc.initialize_bbox_head \
    --src1 work_dirs/tfa_r101_fpn_voc-split1_base-training/latest_arcfaceloss.pth \
    --method randinit \
    --save-dir work_dirs/tfa_r101_fpn_voc-split1_base-training

# step3: few shot fine-tuning
bash ./tools/detection/dist_train.sh \
    configs/detection/tfa/voc/split1-10shot-10shot/tfa_r101_fpn_voc-split1_1shot-fine-tuning.py 8
```
