...
optimizer = dict(lr=0.001,
                 paramwise_cfg=dict(
                     custom_keys={
                         ...
                         # 'roi_head.bbox_head.margin_base': dict(lr_mult=1.0, decay_mult=0.0),
                         # 'roi_head.bbox_head.margin_novel': dict(lr_mult=10.0, decay_mult=0.0),
                     }
                 )
                 )
lr_config = dict(
...
model = dict(
    ...
    #     bbox_head=dict(
    #         # num_classes=20
    #         type='DualMarginArcFaceBBoxHead',
    #         num_classes=20,
    #         margin_base=0.5,
    #         margin_novel=0.3,
    #         s=32,
...
work_dir = './work_dirs/dior-rep/split1/AdaptiveResidual/ETF_r101_fpn_dior-split1_10shot-fine-tuning'
