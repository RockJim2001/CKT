    ...
    roi_head=dict(
            bbox_head=dict(
                ...
                dis_loss=dict(
                    ...
                    loss_neg_margin_weight=1.0,
                    power_weight=4.0),
                base_cpt='work_dirs/dior-rep/split1/tfa_r101_fpn_dior_split1_base-training/base_model_random_init_bbox_head.pth',
                init_cfg=[
                    dict(
                        type='Caffe2Xavier',
                        override=dict(type='Caffe2Xavier', name='base_shared_fcs')),
...
load_from = (
    'work_dirs/dior-rep/split1/tfa_r101_fpn_dior_split1_base-training/base_model_random_init_bbox_head.pth')
work_dir = './work_dirs/dior-rep/split1/power4_0.025_weight_0.5_alpha_tfa_r101_fpn_dior-split1_10shot-fine-tuning'
