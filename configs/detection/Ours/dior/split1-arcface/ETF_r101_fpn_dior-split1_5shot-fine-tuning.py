...
load_from = ('work_dirs/dior-rep/split1/AdaptiveResidual_ArcFace/tfa_r101_fpn_dior_split1_base-training/base_model_random_init_bbox_head.pth')
work_dir = './work_dirs/dior-rep/split1/AdaptiveResidual_ArcFace/ETF_r101_fpn_dior-split1_5shot-fine-tuning'
