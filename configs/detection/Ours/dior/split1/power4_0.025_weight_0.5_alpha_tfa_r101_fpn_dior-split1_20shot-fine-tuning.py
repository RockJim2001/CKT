    ...
    roi_head=dict(
        bbox_head=dict(
            ...
            dis_loss=dict(
                ...
                power_weight=4.0),
            base_cpt='work_dirs/dior/split1-ablation/tfa_r101_fpn_dior_split1_base-training/base_model_random_init_bbox_head_original.pth',
            init_cfg=[
                dict(
                    type='Caffe2Xavier',
...
load_from = ('work_dirs/dior/split1-ablation/tfa_r101_fpn_dior_split1_base-training/base_model_random_init_bbox_head_original.pth')
work_dir = './work_dirs/dior/split1-ablation/power4_0.025_weight_0.5_alpha_tfa_r101_fpn_dior-split2_20shot-fine-tuning.py'
