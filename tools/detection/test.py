...
def main():
    ...
    if not distributed:
        ...
        if cfg.data.get('model_init', None) is not None:
            ...
            from mmfewshot.detection.apis.test_withcolor import single_gpu_test
...
# test_ori
# configs/detection/GFSDet/nwpuv2/split1-ori/power4_0.025_weight_0.5_alpha_tfa_r101_fpn_nwpu-split1_10shot-fine-tuning.py
# /home/whut/Code/G-FSDet/G-FSDet-main/work_dirs/nwpuv2_rep/split1-ori/AdaptiveResidual/tfa_r101_fpn_nwpuv2_split1_base-training/power4_0.025_weight_0.5_alpha_tfa_r101_fpn_nwpu-split1_10shot-fine-tuning/latest.pth
# --out
# work_dirs/nwpuv2_rep/split1-ori/AdaptiveResidual/tfa_r101_fpn_nwpuv2_split1_base-training/power4_0.025_weight_0.5_alpha_tfa_r101_fpn_nwpu-split1_10shot-fine-tuning/result.pkl
# --eval
# mAP
# --show
# --show-score-thr
...
# --gpu-collect
# --show-dir
# work_dirs/nwpuv2_rep/split1-ori/AdaptiveResidual/tfa_r101_fpn_nwpuv2_split1_base-training/power4_0.025_weight_0.5_alpha_tfa_r101_fpn_nwpu-split1_10shot-fine-tuning/show-dir


# test
# configs/detection/GFSDet/nwpuv2/split1/power4_0.025_weight_0.5_alpha_tfa_r101_fpn_nwpu-split1_10shot-fine-tuning.py
# work_dirs/nwpuv2_rep/split1/AdaptiveResidual/tfa_r101_fpn_nwpuv2_split1_base-training/power4_0.025_weight_0.5_alpha_tfa_r101_fpn_nwpu-split1_10shot-fine-tuning/NovelSharedKnowledgeTransferFusion/latest.pth
# --out
# work_dirs/nwpuv2_rep/split1/AdaptiveResidual/tfa_r101_fpn_nwpuv2_split1_base-training/power4_0.025_weight_0.5_alpha_tfa_r101_fpn_nwpu-split1_10shot-fine-tuning/NovelSharedKnowledgeTransferFusion/result.pkl
# --eval
# mAP
# --show
# --show-score-thr
...
# --gpu-collect
# --show-dir
# work_dirs/nwpuv2_rep/split1/AdaptiveResidual/tfa_r101_fpn_nwpuv2_split1_base-training/power4_0.025_weight_0.5_alpha_tfa_r101_fpn_nwpu-split1_10shot-fine-tuning/NovelSharedKnowledgeTransferFusion/show-dir